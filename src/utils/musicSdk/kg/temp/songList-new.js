...
export default {
  ...
  /**
   * Get CollectionId using SpecialId
   * @param {*} specialId
   */
  ...
  /**
   * Get playlist details through CollectionId
   * @param {*} id
   */
  ...
  /**
   * Get playlist through CollectionId
   * @param {*} id
   */
  ...
  /**
   * Filter GlobalSpecialId playlist data
   * @param {*} rawData
   */
      ...
      item.relate_goods.forEach((data) => {
        ...
        switch (data.level) {
          ...
          case 5:
            ...
            break
          case 6:
            types.push({ type: 'hires', size, hash: data.hash })
            _types.hires = {
              size,
              hash: data.hash,
            }
  ...
  /**
   * Get playlist through KuGou code
   * @param {*} id
   * @param {*} page
   */
